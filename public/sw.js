...
let window = {};
// Get the manifest URL from the search param on the service worker registration
const manifestUrl = new URL(self.location).searchParams.get("manifestUrl");
// Import the manifest file that was generated by Remix
...
const MANIFEST_CACHE = MANIFEST_CACHE_PREFIX + manifest.version;
    ...
    caches.keys().then((cacheNames) => {
      return Promise.all(
        cacheNames
          .filter(
            (cacheName) =>
              cacheName.startsWith(MANIFEST_CACHE_PREFIX) &&
